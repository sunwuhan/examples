...
args = {
    "project_id": "hello-generic-world-0419102149",
}

dag = DAG(
    "hello-generic-world-0419102149",
    default_args=args,
...
# Operator source: work/examples/pipelines/run-generic-pipelines-on-apache-airflow/load_data.ipynb
op_bb889c69_b23a_484e_8fb3_e69309f38a98 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "hello-generic-world-0419102149-{{ ts_nodash }}",
    },
    in_cluster=True,
    config_file="None",
    dag=dag,
...
# Operator source: work/examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 1 - Data Cleaning.ipynb
...
# Operator source: work/examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 2 - Data Analysis.ipynb
...
# Operator source: work/examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 3 - Time Series Forecasting.ipynb
